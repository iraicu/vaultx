...
def save_combined():
    ...
    out_png = os.path.join(IMAGES_DIR, "memory_rounds_combined_fpganode2_opi5_rpi5.png")
    fig.savefig(out_png, dpi=300, bbox_inches="tight")
    out_paper = os.path.join(PAPER_IMAGES_DIR, "memory_rounds_combined_fpganode2_opi5_rpi5.png")
