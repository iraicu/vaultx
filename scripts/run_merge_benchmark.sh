...
b_values=(1024 2048 4096 8192 16384)
...
for i in {0..4}; do
    ...
    cmd="stdbuf -o0 -e0 bash -c 'time sudo ./vaultx -P merge -k 32 -n $n -F /data-l/iraicu/tmp/ -T /$drive_name/iraicu/vaults/ -t 1 -R 1024  -A pipelined -B $b' 2>&1 | tee ./logs/$log_file"
