...
make clean
make NONCE_SIZE=5 RECORD_SIZE=16
...
for MEMORY in "${MEMORY_VALUES[@]}"; do
    ...
    # Run VaultX
    ./scripts/vaultx_system_monitor_pidstat.py --plot-file ./vaultx -a for -k 34 -m $MEMORY -W $MEMORY -t 64 -f ./plots/ -g ./plots/ -j ./plots/ -M 1 -x true -n true >> ./data/comparison-to-merge.csv
