...
vaultx_x86: src/vaultx.c src/table2.c src/globals.c blake3/blake3.c blake3/blake3_dispatch.c blake3/blake3_portable.c $(ASM_TARGETS)
	$(CCP) -DNONCE_SIZE=$(NONCE_SIZE) -DRECORD_SIZE=$(RECORD_SIZE) $(CFLAGS) $(EXTRAFLAGS) $^ -x c++ -std=c++17 -o vaultx $(LDFLAGS) -fopenmp -ltbb

vaultx_x86_c: src/vaultx.c src/table2.c src/globals.c blake3/blake3.c blake3/blake3_dispatch.c blake3/blake3_portable.c $(ASM_TARGETS)
	$(CC) -DNONCE_SIZE=$(NONCE_SIZE) -DRECORD_SIZE=$(RECORD_SIZE) -I/usr/include $(CFLAGS) $(EXTRAFLAGS) $^ -o vaultx $(LDFLAGS) -fopenmp

vaultx_x86_xgcc: src/vaultx.c src/table2.c src/globals.c blake3/blake3.c blake3/blake3_dispatch.c blake3/blake3_portable.c $(ASM_TARGETS)
...
vaultx_arm: src/vaultx.c src/table2.c src/globals.c blake3/blake3.c blake3/blake3_dispatch.c blake3/blake3_portable.c
	$(CCP) -DNONCE_SIZE=$(NONCE_SIZE) -DRECORD_SIZE=$(RECORD_SIZE) $(CFLAGS) $(EXTRAFLAGS) $^ -x c++ -std=c++17 -o vaultx $(LDFLAGS) -fopenmp -ltbb 

vaultx_arm_c: src/vaultx.c src/table2.c src/globals.c blake3/blake3.c blake3/blake3_dispatch.c blake3/blake3_portable.c
	$(CC) -DNONCE_SIZE=$(NONCE_SIZE) -DRECORD_SIZE=$(RECORD_SIZE) $(CFLAGS) $(EXTRAFLAGS) $^ -o vaultx $(LDFLAGS) -fopenmp


vaultx_mac: src/vaultx.c src/table2.c src/globals.c
...
vaultx_mac_c: src/vaultx.c src/table2.c src/globals.c
#-D NONCE_SIZE=$(NONCE_SIZE)
